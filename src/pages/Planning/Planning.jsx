  ...
  return (
    <>
      <div className=" pt-[25px] pr-[100px] lg:pt-[50px]  ">
        <h1
          className="text-[#787878]  lg:text-3xl text-center py-2 uppercase tracking-widest leading-tight"
          data-aos="flip-right"
        >
          About Us
        </h1>
        <div className="lg:flex my-[50px] lg:my-[100px] lg:mt-[100px] lg:pl-[120px] ">
          <div>
